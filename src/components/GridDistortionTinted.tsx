...
void main() {
  ...
  // Apply tint
  texColor.rgb = mix(texColor.rgb, tintColor, 0.3);
  
  gl_FragColor = texColor;
}
`

const GridDistortionTinted: React.FC<GridDistortionProps> = ({
  grid = 15,
  mouse = 0.1,
  strength = 0.15,
  relaxation = 0.9,
  ...
  useEffect(() => {
    ...
    const tintColor = new THREE.Color(tintInt)
  ...
  }, [grid, mouse, strength, relaxation, imageSrc, tint])
...
export default GridDistortionTinted
